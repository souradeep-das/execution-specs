...
class Header:
    ...
    [`keccak256`]: ref:ethereum.crypto.hash.keccak256
    [`state_root()`]: ref:ethereum.london.state.state_root
    [Trie]: ref:ethereum.london.trie.Trie
    """
    ...
    [`keccak256`]: ref:ethereum.crypto.hash.keccak256
    [`root()`]: ref:ethereum.london.trie.root
    [Trie]: ref:ethereum.london.trie.Trie
    """
    ...
    [logs bloom]: ref:ethereum.london.bloom.logs_bloom
    """
    ...
    ref:ethereum.london.fork.calculate_block_difficulty
    """
    ...
    [validates]: ref:ethereum.london.fork.validate_proof_of_work
    """
    ...
    [validate]: ref:ethereum.london.fork.validate_proof_of_work
    """
...
class Log:
    ...
    [`LOG0`]: ref:ethereum.london.vm.instructions.log.log0
    [`LOG1`]: ref:ethereum.london.vm.instructions.log.log1
    [`LOG2`]: ref:ethereum.london.vm.instructions.log.log2
    [`LOG3`]: ref:ethereum.london.vm.instructions.log.log3
    [`LOG4`]: ref:ethereum.london.vm.instructions.log.log4
    """
