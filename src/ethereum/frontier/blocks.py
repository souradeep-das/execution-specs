...
class Header:
    ...
    [`keccak256`]: ref:ethereum.crypto.hash.keccak256
    [`state_root()`]: ref:ethereum.frontier.state.state_root
    [Trie]: ref:ethereum.frontier.trie.Trie
    """
    ...
    [`keccak256`]: ref:ethereum.crypto.hash.keccak256
    [`root()`]: ref:ethereum.frontier.trie.root
    [Trie]: ref:ethereum.frontier.trie.Trie
    """
    ...
    [logs bloom]: ref:ethereum.frontier.bloom.logs_bloom
    """
    ...
    ref:ethereum.frontier.fork.calculate_block_difficulty
    """
    ...
    [validates]: ref:ethereum.frontier.fork.validate_proof_of_work
    """
    ...
    [validate]: ref:ethereum.frontier.fork.validate_proof_of_work
    """
...
class Block:
    ...
    [headers]: ref:ethereum.frontier.blocks.Header
    """
...
class Log:
    ...
    [`LOG0`]: ref:ethereum.frontier.vm.instructions.log.log0
    [`LOG1`]: ref:ethereum.frontier.vm.instructions.log.log1
    [`LOG2`]: ref:ethereum.frontier.vm.instructions.log.log2
    [`LOG3`]: ref:ethereum.frontier.vm.instructions.log.log3
    [`LOG4`]: ref:ethereum.frontier.vm.instructions.log.log4
    """
